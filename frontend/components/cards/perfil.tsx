                ...
                <div className="mb-20 grid grid-cols-3 items-stretch mt-40 h-auto">
                    ...
                    <div className="group hover:bg-color5 w-[380px] h-[280px] px-[39.50px] pt-[72px] pb-[71px] bg-neutral-50 rounded-2xl border border-emerald-800 justify-center items-center inline-flex">
                        <button onClick={misMascotas} className="self-stretch p-4 rounded-xl backdrop-blur-[25px] flex-col justify-center items-center gap-6 inline-flex">
                            ...
                            <div className="text-black group-hover:text-color4 text-[28px] font-medium text-center">Mis mascotas</div>
                        </button>
                    </div>
                    <div className="group hover:bg-color5 w-[380px] h-[280px] px-[39.50px] pt-[72px] pb-[71px] bg-neutral-50 rounded-2xl border border-emerald-800 justify-center items-center inline-flex">
                        <button onClick={misReservas} className="self-stretch p-4 rounded-xl backdrop-blur-[25px] flex-col justify-center items-center gap-6 inline-flex">
                            <div className="w-12 h-12 relative">
                                <svg width="36" height="42" viewBox="0 0 36 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="Group">
                                        <path id="Vector" d="M36 18V32C36 33.0609 35.5786 34.0783 34.8284 34.8284C34.0783 35.5786 33.0609 36 32 36H4C2.93913 36 1.92172 35.5786 1.17157 34.8284C0.421427 34.0783 0 33.0609 0 32V18H36ZM26 0C26.5304 0 27.0391 0.210714 27.4142 0.585786C27.7893 0.960859 28 1.46957 28 2V4H32C33.0609 4 34.0783 4.42143 34.8284 5.17157C35.5786 5.92172 36 6.93913 36 8V14H0V8C0 6.93913 0.421427 5.92172 1.17157 5.17157C1.92172 4.42143 2.93913 4 4 4H8V2C8 1.46957 8.21071 0.960859 8.58579 0.585786C8.96086 0.210714 9.46957 0 10 0C10.5304 0 11.0391 0.210714 11.4142 0.585786C11.7893 0.960859 12 1.46957 12 2V4H24V2C24 1.46957 24.2107 0.960859 24.5858 0.585786C24.9609 0.210714 25.4696 0 26 0Z" fill="#0A6141" />
                                    </g>
                                </svg>
                            </div>
                            <div className="text-black group-hover:text-color4 text-[28px] font-medium text-center">Mis reservas</div>
                        </button>
                    </div>
                </div>
            </div>
