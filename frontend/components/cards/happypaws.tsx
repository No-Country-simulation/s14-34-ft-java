...
export default function Happypaws() {
    return (
        <div className="bg-color7 p-2 w-full h-[700px]">
            <div className="justify-self-end px-24">
                ...
                <div className="flex justify-around p-[0px] gap-4">
                    <div className="w-[380px] h-[458px] p-6 bg-white rounded-2xl border border-orange-400 flex-col justify-start items-start gap-2.5 inline-flex">
                        <div className="h-[310px] flex-col justify-start items-start flex">
                            <div className="self-stretch p-2.5 justify-center items-center gap-2.5 inline-flex">
                                <div className="grow shrink basis-0 text-black text-[22px] font-medium ">Tipo de servicio</div>
                            </div>
                            <div className="self-stretch p-2.5 justify-start items-start gap-2.5 inline-flex">
                                ...
                                <div className="grow shrink basis-0 text-neutral-600 text-xl font-normal ">  Breve descricionBreve descricionBreve descricion</div>
                            </div>
                            <div className="self-stretch p-2.5 justify-start items-start gap-2.5 inline-flex">
