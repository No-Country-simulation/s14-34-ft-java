...
export default function Nuestroservicios() {
  ...
  const handleDivClick2 = () => {
    ...
    // Redirige al usuario a la página deseada con la fecha actual en la URL
    router.push(
      `/search/alojamiento/buenos_aires/${fechaActualEnFormato}/perro`
    );
  };
  // visitas
...
font-medium"
      ...
      <div className="flex justify-around p-[80px]">
        <div
          ...
          className="cursor-pointer  w-[380px] h-[400px] shadow-2xl bg-white rounded-2xl flex-col justify-start items-center border-2"
        >
          <Image
            className="self-stretch rounded-tl-2xl rounded-tr-2xl w-[380px] h-[187px] object-cover"
            src="/pprincipal/nuestroservicios/1.png"
            width={380}
            height={187}
            alt="Pasos"
          />
...
font-normal"
            >
              <p>
                Nos aseguramos de que tu compañero reciba el ejercicio para
                mantenerse feliz y saludable con paseadores de confianza.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <Image
            className="self-stretch rounded-tl-2xl rounded-tr-2xl w-[380px] h-[187px] object-cover"
            src="/pprincipal/nuestroservicios/2.jpg"
            width={380}
            height={187}
            alt="Pasos2"
          />
...
font-normal"
            >
              <p>
                Nos encargamos de proporcionar un ambiente cálido y cómodo para
                tu amigo peludo. Con cuidadores amables y atención
                personalizada.
              </p>
            </div>
          </div>
        ...
        >
          <Image
            className="self-stretch rounded-tl-2xl rounded-tr-2xl w-[380px] h-[187px] object-cover"
            src="/pprincipal/nuestroservicios/3.jpg"
            width={380}
            height={187}
            alt="Pasos3"
          />
...
font-normal"
            >
              <p>
                Nuestros cuidadores expertos se desplazan hasta tu hogar para
                alimentar, jugar y mimar a tu mascota.
              </p>
            </div>
          </div>
        </div>
